...
const Cell = ({ status, id, visited, path, row, col, onHandleClick, onMouseOver }) => {
  ...
  return ( 
    <div className={'cell ' + status + (visited ? ' visited' : '') + (path ? ' path' : '')} id={id} row={row} col={col} onMouseDown={handleClick} onMouseEnter={handleMouseOver} >
